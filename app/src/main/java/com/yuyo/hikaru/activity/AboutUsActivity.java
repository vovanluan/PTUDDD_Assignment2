...
public class AboutUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        description.setText("    YuYo helps you learn language(s) by meeting, hangout and practice speaking with a native speaker or someone who already fluent that lives near you.\n\n" +
